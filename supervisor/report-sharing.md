...
Before users can share Supervisor Reports, an organization's admin user must enable the feature in the [Settings](https://app.gitbook.com/s/ifg8pcYnTcaO17HuTu4I/settings "mention") page:
